...
import org.firstinspires.ftc.teamcode.subsystems.drivetrains.RawSetPowerMecanumDrivetrain;

@TeleOp(group = "Drivetrain tests")
public final class TestRawSetDrivePower extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // Initialize robot:
        RawSetPowerMecanumDrivetrain drivetrain = new RawSetPowerMecanumDrivetrain(hardwareMap);
